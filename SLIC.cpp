...
//===========================================================================
//编译 g++ -fopenmp -Ofast SLIC.cpp -o SLIC
//3812 ms
//-O3 3865 ms
#include <stdio.h>
#include <cfloat>
	...
	int & thread_count)
{
	...
	// cout << "RGB2LAB Computing time=" << compTime2.count()/1000 << " ms" << endl;
}
	...
	int &thread_count)//weight given to spatial distance
{
	...
	auto endTime1 = Clock::now();
 	auto compTime1 = chrono::duration_cast<chrono::microseconds>(endTime1 - startTime1);
	cout << "GetLABXYSeeds_ForGivenK Computing time=" << compTime1.count()/1000 << " ms" << endl;
	...
	auto endTime2 = Clock::now();
 	auto compTime2 = chrono::duration_cast<chrono::microseconds>(endTime2 - startTime2);
	cout << "PerformSuperpixelSegmentation_VariableSandM Computing time=" << compTime2.count()/1000 << " ms" << endl;
	numlabels = kseedsl.size();

	int* nlabels = new int[sz];
	auto startTime3 = Clock::now();
